    ...
    <div className="space-y-8">
      <div className="space-y-6">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-black">
          Find Your <span className="text-olive">Book People</span>
        </h1>
        <p className="text-lg md:text-xl text-stone-700 leading-relaxed max-w-lg">
          Connect with fellow book lovers in your neighborhood. Share stories,
          swap favorites, and build a community around the books you love.
        </p>
      </div>
